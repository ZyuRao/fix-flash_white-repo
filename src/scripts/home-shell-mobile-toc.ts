...
export function initHomeShellMobileToc() {
  ...
  document.addEventListener("click", (event) => {
    if (tocMedia.matches || !shell.classList.contains("is-mobile-toc-open")) return;
    const target = event.target;
