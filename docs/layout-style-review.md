...
- 将部分零散 1rem 圆角收拢到 --radius-md，并清理 0rem / 尾随空白等低风险样式噪音
...
- 继续清理剩余无效或噪音布局变量与空媒体查询（已完成一轮低风险样式噪音清理，但尚未彻底收尾）
- 搜索入口已决定保留，后续需要接入真实搜索功能或明确的占位交互
...
当前 header 中的搜索按钮入口已确认保留，但仍未接入真实搜索逻辑。
